...
Config reference: [`deploy/koyeb.yaml`](../../deploy/koyeb.yaml)
...
## Fly.io (optional — requires credit card)

Optional Fly config can be added under `deploy/`. Not used in Option B.
